...
// analyzer.go
// Implementa um analisador de fluxo viário em Go — em memória e com hooks para persistência.
// - Recebe eventos de dispositivos (DeviceEvent) com fluxo [0,1]
// - Atualiza a aresta CONNECT_TO correspondente
// - Recalcula métricas agregadas da OSMWay (avg, min, max, devices_count, last_update)
// - Calcula prioridade [0,100] combinando fluxo e tipo de via (highway)
// - Projeto concorrente e preparado para substituir o storage por um DB (Neo4j/Redis/etc.)
